...
| `FOUNDRY_MCP_LLM_MODEL` | Model identifier | `gpt-4`, `claude-3-sonnet-20240229` |
...
The default provider supporting GPT-4 and GPT-3.5-turbo models.
...
[llm]
provider = "anthropic"
model = "claude-sonnet-4-20250514"  # or "claude-3-opus-20240229", "claude-3-haiku-20240307"
```
