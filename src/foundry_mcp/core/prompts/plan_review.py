...
class PlanReviewPromptBuilder(PromptBuilder):
    ...
    Provides access to both PLAN_REVIEW_* templates (PromptTemplate instances)
    and legacy review_*/security_*/feasibility_*/quick_* templates.

    PLAN_REVIEW Templates (recommended):
        - PLAN_REVIEW_FULL_V1: Comprehensive 6-dimension review
        - PLAN_REVIEW_QUICK_V1: Critical blockers and questions focus
        - PLAN_REVIEW_SECURITY_V1: Security-focused review
    ...
    Example:
        ...
        # Using PLAN_REVIEW_* templates
        prompt = builder.build("PLAN_REVIEW_FULL_V1", {
            "spec_content": "...",
            "spec_id": "my-spec-001",
        ...
        prompt = builder.build("review_spec", {
            "spec_id": "my-spec-001",
            "spec_title": "My Feature Spec",
            "spec_status": "active",
            "spec_content": "...",
        })
    """
    ...
    def build(self, prompt_id: str, context: Dict[str, Any]) -> str:
        ...
        Args:
            prompt_id: Template ID (PLAN_REVIEW_*, SYNTHESIS_PROMPT_V1, or legacy)
        ...
        if prompt_id in TEMPLATES:
            ...
            safe_context = {
                ...
                "cross_phase_deps": context.get(
                    "cross_phase_deps", "None identified"
                ),
        ...
        # Unknown prompt_id
        all_ids = sorted(list(PLAN_REVIEW_TEMPLATES.keys()) + list(TEMPLATES.keys()))
    ...
    def list_prompts(self) -> List[str]:
        ...
        Returns:
            Sorted list of all prompt IDs (PLAN_REVIEW_* and legacy)
        """
        return sorted(list(PLAN_REVIEW_TEMPLATES.keys()) + list(TEMPLATES.keys()))
...
__all__ = [
    ...
    # Legacy templates
    "TEMPLATES",
    "REVIEW_SPEC_TEMPLATE",
    "REVIEW_PHASE_TEMPLATE",
    "SECURITY_REVIEW_TEMPLATE",
    "FEASIBILITY_REVIEW_TEMPLATE",
